...
class WareHouse:
    ...
    def __init__(self, data_input, cls_equipment, count):
        ...
        self.cls_list.append(WareHouse.Valid(count))                # Количество поступившей данной техники
    ...
    def Valid(count):
        ...
        try:
            if type(count) != int:
                ...
                return count
        except TypeError:  # перехват стандартного исключения
            print(ErrorNumber(f"!!! Ошибка ввода. Введено строковое значение - {count}.!!!"))
...
# Проверка запрета передачи количества оргтехники строковым типом
print('*' * 50)
my4 = WareHouse("04.03.2022", my_scanner, '4')
